...
export class FormContainer extends BaseComponent {
	...
	addSimpleInput(styles: string[], id: string, type: string, require = false, placeholder = '', value = '') {
	...
	addInput(
		...
		this.forminputs.push(new FormInput(label, styles, id, type, require, placeholder, value, fstyle));
	}
}
